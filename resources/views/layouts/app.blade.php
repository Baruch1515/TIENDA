    ...
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                ...
                <div class="dropdown">
  <button class="btn btn-secondary dropdown-toggle" style="margin: 15px;" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    Categorias
  </button>
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
  @foreach($categorias as $categoria)
    <a class="dropdown-item" href="{{ $categoria['id'] }}">{{ $categoria['nombre'] }}</a>
    @endforeach
  </div>
</div>
