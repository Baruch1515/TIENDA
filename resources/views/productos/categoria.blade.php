  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <body>
        ...
        <button style="margin: 15px;" type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalnuevacat">
          Nueva Categoria
        </button>

        <!-- Modal -->
        <div class="modal fade" id="modalnuevacat" tabindex="-1" role="dialog" aria-labelledby="modalnuevacat" aria-hidden="true">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
