...
@endforeach
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <h1 style="margin: 30px;">Nuevo Producto</h1>
                <form action="{{url('/productos')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div style="margin: 30px;"class="form-group shadow-textarea">
                        <h4> <label for="exampleFormControlTextarea6">Nombre</label></h4>
                   ...
                   <center> <input style="text-align: center;" type="submit" class="btn btn-success" value="Guardar"></center>
                </form>
