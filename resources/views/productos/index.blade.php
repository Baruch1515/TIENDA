...
-->
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Bodegas</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{count($bodegas)}}</div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-dollar-sign fa-2x text-gray-300"></i>
                                        </div>
  ...
  @foreach($productos as $Producto)
    <tr>
      ...
      <td><form action="{{ url('productos/'.$Producto->id ) }}" method="post">
          @csrf
          {{ method_field('DELETE') }}
...
<div style="text-align: center;" class="footerr">{!! $productos->links() !!}</div>
